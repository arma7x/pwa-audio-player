    ...
    <b-navbar class="shadow-header" type="light" variant="secondary" :sticky="true">
      <!-- <b-navbar-brand> -->
        <span class="col-sm-4 offset-sm-4">
          <a class="float-left font-weight-bold text-white" v-on:click="$router.currentRoute.name != main ? goBack() : null" style="text-decoration:none;">
          ...
          <a class="float-right font-weight-bold text-white" href="https://github.com/arma7x/pwa-audio-player" style="text-decoration:none;" target="_blank" rel="noopener">
            GitHub
            <svg style="width:20px;height:20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 499.36" focusable="false">
              <title>GitHub</title>
